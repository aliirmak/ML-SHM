...
set E_red [expr 0.85*(206.216-0.4884*$K+0.0044*$K*$K)*pow(10.0,9.0)];
...
for {set i 1} {$i <= 40} {incr i} {
    if {$i!=20} {
	    ...
	    element elasticBeamColumn $i $i [expr $i+1] $ACol $E_red $IzCol $ColTransfTag -mass $massDens;
    }
}
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file data/2/1300.txt -time -nodeRange 2 40 -dof 2 accel
...
# DYNAMIC EQ ANALYSIS --------------------------------------------------------
set GMdirection 2;
set GMfile1 "eq/2/1300_1.txt"
set GMfile2 "eq/2/1300_2.txt"
